...
// 全局容器管理（按位置分组）
const notificationContainers: { [key: string]: HTMLElement } = {}
let notificationCount = 0

// 获取或创建容器
const getNotificationContainer = (position: string) => {
...
// 创建通知样式
const createNotificationStyles = (severity: AlertColor) => {
...
// 获取动画配置
const getAnimationConfig = (position: string) => {
