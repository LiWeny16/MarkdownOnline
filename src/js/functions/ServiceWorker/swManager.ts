...
export class ServiceWorkerManager {
    ...
    private constructor(config: SWConfig = {}) {
        this.config = {
            scriptUrl: '/sw.js',
            scope: '/',
            updateViaCache: 'none',
     ...
     */
    public static getInstance(config?: SWConfig): ServiceWorkerManager {
     ...
     * 在页面加载时自动初始化
     */
    public static async autoInit(config?: SWConfig): Promise<ServiceWorkerManager> {
 ...
 */
export async function initServiceWorker(config?: SWConfig): Promise<ServiceWorkerManager> {
