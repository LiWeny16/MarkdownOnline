...
export default class CodePlugin {
    constructor() {
         ...
         */
        Object.defineProperty(this, "addButtonsToCodeBlocks", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: () => {
                const codeBlocks = document.getElementsByClassName("language-code");
        ...
        Object.defineProperty(this, "copyToClipboard", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (block) => {
