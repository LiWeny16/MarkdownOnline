let imagePlugin = function (md) {
    ...
    md.renderer.rules.image = function (tokens, idx, options, env, self) {
        ...
        return `<div class="imgBox-r FLEX  ${position == "C" ? " JUS-CENTER" : position == "R" ? "JUS-RIGHT" : ""}" ><img class="img_resize_transition" width="${width}" style="${style}" src="${src}" alt="${alt}">
    </div>`;
    };
};
export { imagePlugin };
