...
const alertUseArco = (msg, time, objConfig) => {
    ...
    let arcoAlertEle = document.getElementsByClassName("arco-message-wrapper arco-message-wrapper-top")[0];
    if (!arcoAlertEle) {
        kit.addStyle(`.arco-message-wrapper .arco-message-wrapper-top{z-index:${_zIndex}}`);
    }
    else {
