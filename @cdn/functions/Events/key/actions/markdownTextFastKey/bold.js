...
export default function exeBoldAction(editor, monaco) {
    ...
    const newSelection = new monaco.Selection(selection.startLineNumber, selection.startColumn, selection.startLineNumber, selection.startColumn + newText.length);
