...
export default function Settings(props) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(Dialog, { hideBackdrop: true, fullScreen: false, maxWidth: false, open: props.open, onClose: handleCloseAll, PaperProps: {
                    style: {
                        position: 'fixed',
                        ...
                        transition: (isDragging || isResizing) ? 'none' : 'all 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)', // 拖动或调整大小时禁用动画
                            ...
                            userSelect: 'none',
                            transition: (isDragging || isResizing) ? 'none' : 'all 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)', // 拖动或调整大小时禁用动画
                        }, children: [_jsx(Typography, { variant: "body2", sx: { color: theme === "light" ? "#666" : "#ccc" }, children: "LetShare - \u534F\u4F5C\u5206\u4EAB" }), _jsxs(Box, { sx: { display: 'flex', gap: 0.5 }, children: [_jsx(IconButton, { size: "small", onClick: toggleMaximize, children: _jsx(CropFreeIcon, { fontSize: "small" }) }), _jsx(IconButton, { size: "small", onClick: handleCloseAll, children: _jsx(CloseIcon, { fontSize: "small" }) })] })] }), _jsxs(Box, { sx: {
                            ...
                            position: 'relative',
                            transition: (isDragging || isResizing) ? 'none' : 'all 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)', // 拖动或调整大小时禁用动画
                        }, children: [_jsx("iframe", { src: "https://letshare.fun", style: {
                                    width: '100%',
                                    height: '100%',
                                    border: 'none',
                                    borderRadius: '0 0 8px 8px',
                                    background: 'transparent',
                                }, title: "Let's Share", sandbox: "allow-scripts allow-same-origin allow-forms allow-popups allow-presentation" }), (isDragging || isResizing) && (_jsx(Box, { sx: {
                                    position: 'absolute',
                                    top: 0,
                                    left: 0,
                                    width: '100%',
                                    ...
                                    background: 'transparent',
                                            ...
                                            document.addEventListener('mousemove', handleResize);
                                            document.addEventListener('mouseup', handleStop);
                                        } })] }))] })] }), _jsx(ScreenShareIcon, {}), _jsx(Typography, { children: t("t-collaborative-office") })] }));
}
