    ...
    return (_jsxs(_Fragment, { children: [_jsx(Dialog, { className: "avoid", onClose: handleCloseExportImageSetting, open: openExportAsImgSettings, 
                ...
                fullWidth: true, maxWidth: "sm", children: _jsxs("div", { onClick: (e) => {
                    ...
                    closeExportMenu(e);
                            ...
                            myPrint();
                        }, disableRipple: true, children: [_jsx(PictureAsPdfIcon, {}), t("t-export-pdf")] }), _jsxs(MenuItem, { onClick: (e) => {
                            // handleClose()
                            // exportAsImage()
                            setOpenExportAsImgSettings(true);
                            // closeMenu()
                            closeExportMenu(e);
                        }, disableRipple: true, children: [_jsx(AddPhotoAlternateIcon, {}), t("t-export-image")] }), _jsxs(MenuItem, { onClick: () => {
                            exportAsMd();
                        }, disableRipple: true, children: [_jsx(ShortTextIcon, {}), t("t-export-markdown")] })] })] }));
}
