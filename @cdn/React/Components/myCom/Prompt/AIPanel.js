                    ...
                    pointerEvents: showState ? "auto" : "none",
                        ...
                        backgroundColor: getTheme() === "light" ? "white" : "#333",
                                        ...
                                        flex: "0 0 89%",
                                            ...
                                            height: "6svh", // 确保高度一致
                                            transform: "scale(1)", // 确保没有缩放差异
                                        }, onClick: handleSend, "aria-label": "\u53D1\u9001", disabled: isStreaming, children: _jsx(SearchIcon, { style: { fontSize: "1.2rem" } }) })) })] }), _jsxs(Box, { className: "FLEX COW", sx: { alignItems: "center", paddingRight: "10px" }, children: [_jsx(Tooltip, { title: "Ctrl+J", children: _jsxs(IconButtonSq, { style: { padding: "0px 20px", fontWeight: "700" }, children: [_jsx(ChatIcon, { style: { fontSize: "1.2rem", marginRight: "4px" } }), " Ask AI"] }) }), _jsx(Tooltip, { title: "\u9009\u62E9\u56FE\u7247", children: _jsx(IconButtonSq, { onClick: handleImageUploadClick, "aria-label": "\u9009\u62E9\u56FE\u7247", style: { padding: "0px 20px", fontWeight: "700" }, children: _jsx(PhotoCameraIcon, { style: { fontSize: "1.2rem" } }) }) }), _jsx(Box, { sx: { ml: 1, flex: 1, display: 'flex', justifyContent: 'center', opacity: 0.5, userSelect: 'none' }, children: _jsx(Typography, { variant: "caption", children: "Press Ctrl + Enter To Send" }) }), imageBase64 && (_jsxs(Box, { sx: { ml: 1, position: "relative", display: "inline-block" }, children: [_jsx("img", { src: imageBase64, alt: "\u56FE\u7247\u9884\u89C8", style: {
                                                width: 35,
                                                height: 35,
                                                borderRadius: "1px",
                                                objectFit: "cover",
                                                ...
                                                padding: 0,
                                                zIndex: 1,
                                            }, children: _jsx(CloseIcon, { style: { fontSize: 16 } }) })] })), _jsx(Tooltip, { title: "\u63A5\u53D7AI\u5E76\u63D2\u5165\u7F16\u8F91\u5668", children: _jsx("span", { children: _jsx(IconButtonSq, { onClick: handleInsertAIResponse, "aria-label": "\u63D2\u5165", disabled: !isEnd, style: { padding: "0px 20px", fontWeight: "700" }, children: _jsx(WrapTextIcon, { style: { fontSize: "1.2rem" } }) }) }) })] })] }) }), _jsx("input", { type: "file", accept: "image/*", ref: fileInputRef, style: { display: "none" }, onChange: handleFileUpload })] }));
});
